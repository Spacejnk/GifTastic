...
function getGiphyData(e){
    ...
    var queryUrl = 'https://api.giphy.com/v1/gifs/search?api_key=VCtHRNm0rquIRq8e5hKxc3yp5uhoItho&q='+this.innerText;
        ...
        for (i in  gifsLink) {
            $('.results').append("<img src=' "+ gifsLink[i].images.original.url+ " ' style='height:350px; width:350px; '/ >")
